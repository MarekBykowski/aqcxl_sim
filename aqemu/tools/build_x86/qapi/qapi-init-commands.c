...
void qmp_init_marshal(QmpCommandList *cmds)
{
    ...
    qmp_register_command(cmds, "readmem",
                         qmp_marshal_readmem, 0, 0);
    qmp_register_command(cmds, "writemem",
                         qmp_marshal_writemem, 0, 0);
    qmp_register_command(cmds, "triggerevent",
                         qmp_marshal_triggerevent, 0, 0);
    qmp_register_command(cmds, "injectgpio",
                         qmp_marshal_injectgpio, 0, 0);
