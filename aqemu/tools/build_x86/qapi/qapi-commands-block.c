...
void qmp_marshal_blockdev_change_medium(QDict *args, QObject **ret, Error **errp)
{
    ...
    qmp_blockdev_change_medium(arg.has_device, arg.device, arg.has_id, arg.id, arg.filename, arg.has_format, arg.format, arg.has_force, arg.force, arg.has_read_only_mode, arg.read_only_mode, &err);
    if (err) {
