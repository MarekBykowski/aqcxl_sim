...
uint16_t _TRACE_PCI_NVME_EVENTIDX_CQ_DSTATE;
uint16_t _TRACE_PCI_NVME_EVENTIDX_SQ_DSTATE;
...
uint16_t _TRACE_PCI_NVME_SHADOW_DOORBELL_CQ_DSTATE;
uint16_t _TRACE_PCI_NVME_SHADOW_DOORBELL_SQ_DSTATE;
...
TraceEvent _TRACE_PCI_NVME_EVENTIDX_CQ_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "pci_nvme_eventidx_cq",
    .sstate = TRACE_PCI_NVME_EVENTIDX_CQ_ENABLED,
    .dstate = &_TRACE_PCI_NVME_EVENTIDX_CQ_DSTATE 
};
TraceEvent _TRACE_PCI_NVME_EVENTIDX_SQ_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "pci_nvme_eventidx_sq",
    .sstate = TRACE_PCI_NVME_EVENTIDX_SQ_ENABLED,
    .dstate = &_TRACE_PCI_NVME_EVENTIDX_SQ_DSTATE 
};
...
TraceEvent _TRACE_PCI_NVME_SHADOW_DOORBELL_CQ_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "pci_nvme_shadow_doorbell_cq",
    .sstate = TRACE_PCI_NVME_SHADOW_DOORBELL_CQ_ENABLED,
    .dstate = &_TRACE_PCI_NVME_SHADOW_DOORBELL_CQ_DSTATE 
};
TraceEvent _TRACE_PCI_NVME_SHADOW_DOORBELL_SQ_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "pci_nvme_shadow_doorbell_sq",
    .sstate = TRACE_PCI_NVME_SHADOW_DOORBELL_SQ_ENABLED,
    .dstate = &_TRACE_PCI_NVME_SHADOW_DOORBELL_SQ_DSTATE 
};
...
TraceEvent *hw_nvme_trace_events[] = {
    ...
    &_TRACE_PCI_NVME_EVENTIDX_CQ_EVENT,
    &_TRACE_PCI_NVME_EVENTIDX_SQ_EVENT,
    ...
    &_TRACE_PCI_NVME_SHADOW_DOORBELL_CQ_EVENT,
    &_TRACE_PCI_NVME_SHADOW_DOORBELL_SQ_EVENT,
