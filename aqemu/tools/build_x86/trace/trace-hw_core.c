...
uint16_t _TRACE_REMOTE_PORT_MEMORY_MASTER_TX_BUSACCESS_DSTATE;
uint16_t _TRACE_REMOTE_PORT_MEMORY_MASTER_RX_BUSACCESS_DSTATE;
uint16_t _TRACE_REMOTE_PORT_MEMORY_SLAVE_TX_BUSACCESS_DSTATE;
uint16_t _TRACE_REMOTE_PORT_MEMORY_SLAVE_RX_BUSACCESS_DSTATE;
uint16_t _TRACE_REMOTE_PORT_GPIO_TX_INTERRUPT_DSTATE;
uint16_t _TRACE_REMOTE_PORT_GPIO_RX_INTERRUPT_DSTATE;
uint16_t _TRACE_REMOTE_PORT_STREAM_TX_BUSACCESS_DSTATE;
uint16_t _TRACE_REMOTE_PORT_STREAM_RX_BUSACCESS_DSTATE;
...
TraceEvent _TRACE_REMOTE_PORT_MEMORY_MASTER_TX_BUSACCESS_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "remote_port_memory_master_tx_busaccess",
    .sstate = TRACE_REMOTE_PORT_MEMORY_MASTER_TX_BUSACCESS_ENABLED,
    .dstate = &_TRACE_REMOTE_PORT_MEMORY_MASTER_TX_BUSACCESS_DSTATE 
};
TraceEvent _TRACE_REMOTE_PORT_MEMORY_MASTER_RX_BUSACCESS_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "remote_port_memory_master_rx_busaccess",
    .sstate = TRACE_REMOTE_PORT_MEMORY_MASTER_RX_BUSACCESS_ENABLED,
    .dstate = &_TRACE_REMOTE_PORT_MEMORY_MASTER_RX_BUSACCESS_DSTATE 
};
TraceEvent _TRACE_REMOTE_PORT_MEMORY_SLAVE_TX_BUSACCESS_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "remote_port_memory_slave_tx_busaccess",
    .sstate = TRACE_REMOTE_PORT_MEMORY_SLAVE_TX_BUSACCESS_ENABLED,
    .dstate = &_TRACE_REMOTE_PORT_MEMORY_SLAVE_TX_BUSACCESS_DSTATE 
};
TraceEvent _TRACE_REMOTE_PORT_MEMORY_SLAVE_RX_BUSACCESS_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "remote_port_memory_slave_rx_busaccess",
    .sstate = TRACE_REMOTE_PORT_MEMORY_SLAVE_RX_BUSACCESS_ENABLED,
    .dstate = &_TRACE_REMOTE_PORT_MEMORY_SLAVE_RX_BUSACCESS_DSTATE 
};
TraceEvent _TRACE_REMOTE_PORT_GPIO_TX_INTERRUPT_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "remote_port_gpio_tx_interrupt",
    .sstate = TRACE_REMOTE_PORT_GPIO_TX_INTERRUPT_ENABLED,
    .dstate = &_TRACE_REMOTE_PORT_GPIO_TX_INTERRUPT_DSTATE 
};
TraceEvent _TRACE_REMOTE_PORT_GPIO_RX_INTERRUPT_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "remote_port_gpio_rx_interrupt",
    .sstate = TRACE_REMOTE_PORT_GPIO_RX_INTERRUPT_ENABLED,
    .dstate = &_TRACE_REMOTE_PORT_GPIO_RX_INTERRUPT_DSTATE 
};
TraceEvent _TRACE_REMOTE_PORT_STREAM_TX_BUSACCESS_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "remote_port_stream_tx_busaccess",
    .sstate = TRACE_REMOTE_PORT_STREAM_TX_BUSACCESS_ENABLED,
    .dstate = &_TRACE_REMOTE_PORT_STREAM_TX_BUSACCESS_DSTATE 
};
TraceEvent _TRACE_REMOTE_PORT_STREAM_RX_BUSACCESS_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "remote_port_stream_rx_busaccess",
    .sstate = TRACE_REMOTE_PORT_STREAM_RX_BUSACCESS_ENABLED,
    .dstate = &_TRACE_REMOTE_PORT_STREAM_RX_BUSACCESS_DSTATE 
};
TraceEvent *hw_core_trace_events[] = {
    ...
    &_TRACE_REMOTE_PORT_MEMORY_MASTER_TX_BUSACCESS_EVENT,
    &_TRACE_REMOTE_PORT_MEMORY_MASTER_RX_BUSACCESS_EVENT,
    &_TRACE_REMOTE_PORT_MEMORY_SLAVE_TX_BUSACCESS_EVENT,
    &_TRACE_REMOTE_PORT_MEMORY_SLAVE_RX_BUSACCESS_EVENT,
    &_TRACE_REMOTE_PORT_GPIO_TX_INTERRUPT_EVENT,
    &_TRACE_REMOTE_PORT_GPIO_RX_INTERRUPT_EVENT,
    &_TRACE_REMOTE_PORT_STREAM_TX_BUSACCESS_EVENT,
    &_TRACE_REMOTE_PORT_STREAM_RX_BUSACCESS_EVENT,
  NULL,
};
